...
Developing the trading platform. Implementing various front-office and back-office tasks,
...
\begin{itemize}
    ...
    \item Built a monorepo (for libs) and CI pipeline, fixed bugs in
          \href{https://github.com/mojohaus/flatten-maven-plugin/pull/152}{maven-flatten-plugin}
          and  \href{https://github.com/apache/maven/pull/347}{maven};
